...
const languageStrings = {
    en: {
        translation: {
            WELCOME_MESSAGE: 'Hello! This is a degree converter.',
    ...
    es: {
        translation: {
            WELCOME_MESSAGE: '¡Hola! Este es un convertidor de grados',
...
const ConversorIntentHandler = { // FUNCION DE CENTIGRADOS A FARENHEIT *****************************************************
    ...
    handle(handlerInput) {
        ...
        const speakOutput = `${iniciar} ${resultado} grados Fahrenheit`;
